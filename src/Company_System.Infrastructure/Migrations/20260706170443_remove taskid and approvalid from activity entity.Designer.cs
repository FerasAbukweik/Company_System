...
namespace HR_System.Infrastructure.Migrations
{
    ...
    [Migration("20260706170443_remove taskid and approvalid from activity entity")]
    partial class removetaskidandapprovalidfromactivityentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HR_System.Core.Domain.Entities.Activity", b =>
                {
                    b.HasOne("HR_System.Core.Domain.Entities.AppTask", null)
                        .WithMany("Activities")
                        .HasForeignKey("AppTaskId");

                    b.HasOne("HR_System.Core.Domain.Entities.Approval", null)
                        .WithMany("Activities")
